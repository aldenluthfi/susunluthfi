...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/home/aldenluthfi/.pyenv/versions/3.13.2/bin',
    'BINLIBDEST': '/home/aldenluthfi/.pyenv/versions/3.13.2/lib/python3.13',
    'BLDLIBRARY': '-L. -lpython3.13',
    'BLDSHARED': 'gcc -shared -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CONFIGURE_CPPFLAGS': '-I/home/aldenluthfi/.pyenv/versions/3.13.2/include',
    'CONFIGURE_LDFLAGS': '-L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--prefix=/home/aldenluthfi/.pyenv/versions/3.13.2' '--enable-shared' '--libdir=/home/aldenluthfi/.pyenv/versions/3.13.2/lib' 'LDFLAGS=-L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib' 'LIBS=-L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib' 'CPPFLAGS=-I/home/aldenluthfi/.pyenv/versions/3.13.2/include'",
    'CONFINCLUDEDIR': '/home/aldenluthfi/.pyenv/versions/3.13.2/include',
    'CONFINCLUDEPY': '/home/aldenluthfi/.pyenv/versions/3.13.2/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/tmp/python-build.20250321074242.16275/Python-3.13.2/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/tmp/python-build.20250321074242.16275/Python-3.13.2/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include',
    'CXX': 'g++',
    'DESTDIRS': '/home/aldenluthfi/.pyenv/versions/3.13.2 /home/aldenluthfi/.pyenv/versions/3.13.2/lib /home/aldenluthfi/.pyenv/versions/3.13.2/lib/python3.13 /home/aldenluthfi/.pyenv/versions/3.13.2/lib/python3.13/lib-dynload',
    'DESTLIB': '/home/aldenluthfi/.pyenv/versions/3.13.2/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/home/aldenluthfi/.pyenv/versions/3.13.2/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/home/aldenluthfi/.pyenv/versions/3.13.2/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/home/aldenluthfi/.pyenv/versions/3.13.2/include /home/aldenluthfi/.pyenv/versions/3.13.2/include /home/aldenluthfi/.pyenv/versions/3.13.2/include/python3.13 /home/aldenluthfi/.pyenv/versions/3.13.2/include/python3.13',
    'INCLUDEDIR': '/home/aldenluthfi/.pyenv/versions/3.13.2/include',
    'INCLUDEPY': '/home/aldenluthfi/.pyenv/versions/3.13.2/include/python3.13',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'g++ -shared -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'LDFLAGS': '-L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -shared -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/home/aldenluthfi/.pyenv/versions/3.13.2/lib/python3.13',
    'LIBDIR': '/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/home/aldenluthfi/.pyenv/versions/3.13.2/lib/pkgconfig',
    'LIBPL': '/home/aldenluthfi/.pyenv/versions/3.13.2/lib/python3.13/config-3.13-x86_64-linux-gnu',
    'LIBPYTHON': '',
    'LIBRARY': 'libpython3.13.a',
    'LIBRARY_DEPS': 'libpython3.13.a libpython3.13.so libpython3.so',
    'LIBRARY_OBJS': '\\',
    'LIBRARY_OBJS_OMIT_FROZEN': '\\',
    'LIBS': '-ldl -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': 'gcc',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/home/aldenluthfi/.pyenv/versions/3.13.2/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/home/aldenluthfi/.pyenv/versions/3.13.2/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -fPIC -DPy_BUILD_CORE_BUILTIN',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'PY_CPPFLAGS': '-I. -I./Include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 1,
    'PY_LDFLAGS': '-L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -I/home/aldenluthfi/.pyenv/versions/3.13.2/include -fPIC',
    'PY_SUPPORT_TIER': 1,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'RESSRCDIR': '',
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/python-build.20250321074242.16275/Python-3.13.2',
    'SCRIPTDIR': '/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    ...
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl -L/home/aldenluthfi/.pyenv/versions/3.13.2/lib -Wl,-rpath,/home/aldenluthfi/.pyenv/versions/3.13.2/lib',
    'SHLIB_SUFFIX': '.so',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/python-build.20250321074242.16275/Python-3.13.2 ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/python-build.20250321074242.16275/Python-3.13.2 ./python -E -m test',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './home/aldenluthfi/.pyenv/versions/3.13.2',
    'WASM_STDLIB': './home/aldenluthfi/.pyenv/versions/3.13.2/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 0,
    ...
    'abs_builddir': '/tmp/python-build.20250321074242.16275/Python-3.13.2',
    'abs_srcdir': '/tmp/python-build.20250321074242.16275/Python-3.13.2',
    'datarootdir': '/home/aldenluthfi/.pyenv/versions/3.13.2/share',
    'exec_prefix': '/home/aldenluthfi/.pyenv/versions/3.13.2',
    'prefix': '/home/aldenluthfi/.pyenv/versions/3.13.2',
    'srcdir': '.',
}
